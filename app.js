      ...
      db.collection('employee_config').get()
          .then(snapshot => {
              ...
              snapshot.forEach(doc => {
                  ...
                  if (userId && name) {
                      allEmployees.push({...data, userId: userId, name: name});
                      ...
                      itemEmp.innerHTML = `${name} <span class="username">${username}</span> <span class="chip" style="background: var(--good);">Activo</span>`;
                      ...
                      itemSchedule.setAttribute('data-user-id', userId);
                      itemSchedule.textContent = name;
                      itemSchedule.addEventListener('click', () => {
                           selectEmployeeSchedule(userId);
                      });
